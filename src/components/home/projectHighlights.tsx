  ...
  return (
    <div className="h-full w-full bg-white">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row w-64 md:w-full lg:max-w-6xl space-y-4 md:space-y-0 md:space-x-2 lg:space-x-16 ">
          <div className="bg-white shadow-md border border-dn-beige flex-1 ">
            ...
            <div className="p-4 lg:p-10 space-y-2 h-40 overflow-y-scroll">
          ...
          <div className="bg-white shadow-md border border-dn-beige  flex-1 ">
            ...
            <div className="p-4 lg:p-10 space-y-2 h-40 overflow-y-auto">
              <p className={`${styles.paragraph} text-black text-sm`}>
