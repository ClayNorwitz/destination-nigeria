...
export default function WeAreNigeria() {
  ...
  return (
    <div className="bg-dn-orange h-full w-full">
      <div
        className={` flex flex-col justify-center items-center h-full   px-14 md:px-0 md:w-full max-w-5xl ${styles.boxWidth}`}
      >
        ...
        <Image
          src="/img/destination-nigeria-logo-white.png"
          width={428}
          height={165}
          alt="Picture green and orange pattern"
          className="pt-6"
        />
        <div className="flex w-full items-center justify-center space-x-6 pt-10">
