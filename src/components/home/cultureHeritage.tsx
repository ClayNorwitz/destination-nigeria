...
export default function CultureHeritage() {
  return (
    <div className="relative bg-white">
      <div className={`grid grid-cols-3 items-center py-24 ${styles.boxWidth}`}>
        <div className="col-span-2 ">
          ...
          <div className="relative flex">
            <div className=" flex flex-col items-center justify-end space-y-6 pr-10">
              <div className="w-1 h-[23%] bg-white"></div>
        ...
        <div className="col-span-1 ">
          ...
          <div className="space-y-2">
            <p className={`${styles.paragraphBold} text-lg text-dn-mint`}>
