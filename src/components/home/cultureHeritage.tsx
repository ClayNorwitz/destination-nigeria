...
export default function CultureHeritage() {
  return (
    <div className="relative bg-white ">
      <div
        className={`grid grid-cols-3 items-center py-24  ${styles.boxWidth}`}
      >
        <div className="col-span-3 lg:col-span-2 ">
          <div className="bg-dn-mint h-full w-1/4 absolute top-0 left-0"></div>
          <div className="relative flex">
            <div className=" flex flex-col items-center justify-end space-y-6 pr-10">
              <div className="w-px h-full lg:h-[18%] bg-white"></div>
        ...
        <div className="col-span-3 lg:col-span-1 relative pt-16 lg:pt-0">
          ...
          <div className="space-y-6">
            <p
              className={`${styles.paragraphBold} text-xl lg:text-3xl text-black lg:text-dn-mint`}
            >
